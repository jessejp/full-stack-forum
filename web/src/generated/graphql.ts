...
export type PostsQuery = { __typename?: 'Query', posts: Array<{ __typename?: 'Post', _id: number, title: string, textSnippet: string, creatorId: number, points: number, createdAt: any, updatedAt: any }> };
